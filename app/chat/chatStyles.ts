...
export const getChatStyles = (isDark: boolean) => {
  ...
  return StyleSheet.create({
    ...
    imagePreviewFooter: { paddingBottom: 24, paddingHorizontal: 12, alignItems: 'center', gap: 10 },
    imagePreviewToolbar: {
      flexDirection: 'row',
      alignItems: 'center',
      justifyContent: 'center',
    ...
    imagePreviewHint: { color: 'rgba(255, 255, 255, 0.5)', fontSize: 12, textAlign: 'center' },
    ...
    reactionsFloatingMine: { right: 4, justifyContent: 'flex-end' },
    reactionsFloatingOther: { left: 4, justifyContent: 'flex-start' },
    reactionBadge: {
      flexDirection: 'row',
      alignItems: 'center',
    ...
    reactionEmoji: { fontSize: 11, lineHeight: 14 },
    reactionCount: { fontSize: 9, color: textSecondary, marginLeft: 1, fontWeight: '600' },
